...
val modId: String = "monstersburn"

base {
    archivesName.set("MonstersBurn-$minecraftVersion")
    group = "github.dsnarski33.monstersburn"
    version = modVersion
}
...
mixin {
    add(sourceSets.main.get(), "monstersburn.refmap.json")
}
